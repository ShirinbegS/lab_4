...
for product, prices in sweets.items():
    # Сортируем список магазинов по цене
    sorted_prices = sorted(prices, key=lambda x: x['price'])

    print(product)
    # Выводим два магазина с минимальными ценами
    print(sorted_prices[0]['shop'])
    print(sorted_prices[1]['shop'])